...
function createBaseSetStripeConnectionDataResponse(): SetStripeConnectionDataResponse {
  return {};
}

export const SetStripeConnectionDataResponse: MessageFns<SetStripeConnectionDataResponse> = {
  encode(_: SetStripeConnectionDataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SetStripeConnectionDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(_: any): SetStripeConnectionDataResponse {
    return {};
  },

  toJSON(_: SetStripeConnectionDataResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create(base?: DeepPartial<SetStripeConnectionDataResponse>): SetStripeConnectionDataResponse {
    return SetStripeConnectionDataResponse.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<SetStripeConnectionDataResponse>): SetStripeConnectionDataResponse {
    const message = createBaseSetStripeConnectionDataResponse();
    return message;
  },
};
