...
exports.ListKnownBOSSAppsResponse = exports.ListKnownBOSSAppsRequest = exports.BOSSApp = void 0;
...
// @generated message type with reflection information, may provide speed optimized methods
class ListKnownBOSSAppsRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.ListKnownBOSSAppsRequest", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
 ...
 */
exports.ListKnownBOSSAppsRequest = new ListKnownBOSSAppsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListKnownBOSSAppsResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.ListKnownBOSSAppsResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated boss.v2.BOSSApp apps */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated boss.v2.BOSSApp apps = 1; */
