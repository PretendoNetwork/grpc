...
class ListTasksRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.ListTasksRequest", []);
    }
    create(value) {
 ...
 */
exports.ListTasksRequest = new ListTasksRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListTasksResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.ListTasksResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated boss.v2.Task tasks */ 1:
