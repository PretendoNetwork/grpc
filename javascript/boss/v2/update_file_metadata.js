...
exports.UpdateFileMetadataResponse = exports.UpdateFileMetadataRequest = exports.UpdateFileMetadataData = void 0;
...
class UpdateFileMetadataData$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.UpdateFileMetadataData", [
...
class UpdateFileMetadataRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.UpdateFileMetadataRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 data_id */ 1:
                    ...
                    break;
                case /* boss.v2.UpdateFileMetadataData update_data */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* boss.v2.UpdateFileMetadataData update_data = 2; */
...
// @generated message type with reflection information, may provide speed optimized methods
class UpdateFileMetadataResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("boss.v2.UpdateFileMetadataResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
 ...
 */
exports.UpdateFileMetadataResponse = new UpdateFileMetadataResponse$Type();
