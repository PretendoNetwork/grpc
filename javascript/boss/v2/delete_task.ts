...
export const DeleteTaskResponse: MessageFns<DeleteTaskResponse> = {
  encode(_: DeleteTaskResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create(base?: DeepPartial<DeleteTaskResponse>): DeleteTaskResponse {
    return DeleteTaskResponse.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<DeleteTaskResponse>): DeleteTaskResponse {
    const message = createBaseDeleteTaskResponse();
    return message;
  },
};
