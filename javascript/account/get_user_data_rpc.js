...
class GetUserDataRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("account.GetUserDataRequest", [
...
class GetUserDataResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("account.GetUserDataResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string tier_name */ 13:
                    ...
                    break;
                case /* account.PNIDPermissionFlags permissions */ 14:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* account.PNIDPermissionFlags permissions = 14; */
