...
class GetNEXDataRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("account.GetNEXDataRequest", [
...
class GetNEXDataResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("account.GetNEXDataResponse", [
            { no: 1, name: "pid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            ...
            { no: 7, name: "device_type", kind: "enum", T: () => ["account.DeviceType", DeviceType] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string friend_code */ 6:
                    ...
                    break;
                case /* account.DeviceType device_type */ 7:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* account.DeviceType device_type = 7; */
