...
export declare function auditLogActionTypeFromJSON(object: any): AuditLogActionType;
export declare function auditLogActionTypeToJSON(object: AuditLogActionType): string;
