...
function createBaseExchangeTokenForUserDataResponse() {
    return {
        deleted: false,
        pid: 0,
        username: "",
...
exports.ExchangeTokenForUserDataResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.ExchangeTokenForUserDataResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExchangeTokenForUserDataResponse();
