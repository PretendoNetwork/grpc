...
function createBaseExchangeTokenForUserDataResponse(): ExchangeTokenForUserDataResponse {
  return {
    deleted: false,
    pid: 0,
    username: "",
...
export const ExchangeTokenForUserDataResponse: MessageFns<ExchangeTokenForUserDataResponse> = {
  encode(message: ExchangeTokenForUserDataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExchangeTokenForUserDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExchangeTokenForUserDataResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ExchangeTokenForUserDataResponse {
    return {
  ...
  toJSON(message: ExchangeTokenForUserDataResponse): unknown {
    const obj: any = {};
    if (message.deleted !== false) {
  ...
  create(base?: DeepPartial<ExchangeTokenForUserDataResponse>): ExchangeTokenForUserDataResponse {
    return ExchangeTokenForUserDataResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExchangeTokenForUserDataResponse>): ExchangeTokenForUserDataResponse {
    const message = createBaseExchangeTokenForUserDataResponse();
