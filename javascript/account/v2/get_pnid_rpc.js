...
exports.GetPNIDResponse = exports.GetPNIDRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseGetPNIDRequest() {
    return { pid: 0 };
}
exports.GetPNIDRequest = {
    ...
    create(base) {
        return exports.GetPNIDRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetPNIDRequest();
...
function createBaseGetPNIDResponse() {
    return {
        deleted: false,
        pid: 0,
        username: "",
...
exports.GetPNIDResponse = {
    ...
    create(base) {
        return exports.GetPNIDResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetPNIDResponse();
