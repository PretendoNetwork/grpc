...
const file_boss_v2_upload_file_proto_rawDesc = "" +
	"\n" +
	"\x19boss/v2/upload_file.proto\x12\aboss.v2\x1a\x12boss/v2/file.proto\"\xd8\x03\n" +
	...
	"\x13name_equals_data_id\x18\x0e \x01(\bR\x10nameEqualsDataId\"7\n" +
	"\x12UploadFileResponse\x12!\n" +
	"\x04file\x18\x01 \x01(\v2\r.boss.v2.FileR\x04fileB\x8e\x01\n" +
	"\vcom.boss.v2B\x0fUploadFileProtoP\x01Z1github.com/PretendoNetwork/grpc/go/boss/v2;bossv2\xa2\x02\x03BXX\xaa\x02\aBoss.V2\xca\x02\aBoss\\V2\xe2\x02\x13Boss\\V2\\GPBMetadata\xea\x02\bBoss::V2b\x06proto3"

var (
	file_boss_v2_upload_file_proto_rawDescOnce sync.Once
	file_boss_v2_upload_file_proto_rawDescData []byte
)

func file_boss_v2_upload_file_proto_rawDescGZIP() []byte {
	file_boss_v2_upload_file_proto_rawDescOnce.Do(func() {
		file_boss_v2_upload_file_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_boss_v2_upload_file_proto_rawDesc), len(file_boss_v2_upload_file_proto_rawDesc)))
	})
...
func file_boss_v2_upload_file_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_boss_v2_upload_file_proto_rawDesc), len(file_boss_v2_upload_file_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
