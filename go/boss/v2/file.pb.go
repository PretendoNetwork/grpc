...
const file_boss_v2_file_proto_rawDesc = "" +
	"\n" +
	"\x12boss/v2/file.proto\x12\aboss.v2\"\xde\x04\n" +
	"\x04File\x12\x18\n" +
	...
	"\x11updated_timestamp\x18\x13 \x01(\x04R\x10updatedTimestampB\x88\x01\n" +
	"\vcom.boss.v2B\tFileProtoP\x01Z1github.com/PretendoNetwork/grpc/go/boss/v2;bossv2\xa2\x02\x03BXX\xaa\x02\aBoss.V2\xca\x02\aBoss\\V2\xe2\x02\x13Boss\\V2\\GPBMetadata\xea\x02\bBoss::V2b\x06proto3"

var (
	file_boss_v2_file_proto_rawDescOnce sync.Once
	file_boss_v2_file_proto_rawDescData []byte
)

func file_boss_v2_file_proto_rawDescGZIP() []byte {
	file_boss_v2_file_proto_rawDescOnce.Do(func() {
		file_boss_v2_file_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_boss_v2_file_proto_rawDesc), len(file_boss_v2_file_proto_rawDesc)))
	})
...
func file_boss_v2_file_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_boss_v2_file_proto_rawDesc), len(file_boss_v2_file_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
