...
const file_boss_v2_update_file_metadata_proto_rawDesc = "" +
	"\n" +
	"\"boss/v2/update_file_metadata.proto\x12\aboss.v2\"\x9a\x03\n" +
	...
	"\n" +
	"notify_led\x18\f \x01(\bR\tnotifyLed\"v\n" +
	"\x19UpdateFileMetadataRequest\x12\x17\n" +
	"\adata_id\x18\x01 \x01(\x04R\x06dataId\x12@\n" +
	"\vupdate_data\x18\x02 \x01(\v2\x1f.boss.v2.UpdateFileMetadataDataR\n" +
	"updateData\"\x1c\n" +
	"\x1aUpdateFileMetadataResponseB\x96\x01\n" +
	"\vcom.boss.v2B\x17UpdateFileMetadataProtoP\x01Z1github.com/PretendoNetwork/grpc/go/boss/v2;bossv2\xa2\x02\x03BXX\xaa\x02\aBoss.V2\xca\x02\aBoss\\V2\xe2\x02\x13Boss\\V2\\GPBMetadata\xea\x02\bBoss::V2b\x06proto3"

var (
	file_boss_v2_update_file_metadata_proto_rawDescOnce sync.Once
	file_boss_v2_update_file_metadata_proto_rawDescData []byte
)

func file_boss_v2_update_file_metadata_proto_rawDescGZIP() []byte {
	file_boss_v2_update_file_metadata_proto_rawDescOnce.Do(func() {
		file_boss_v2_update_file_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_boss_v2_update_file_metadata_proto_rawDesc), len(file_boss_v2_update_file_metadata_proto_rawDesc)))
	})
...
func file_boss_v2_update_file_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_boss_v2_update_file_metadata_proto_rawDesc), len(file_boss_v2_update_file_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
