...
const file_api_v2_api_service_proto_rawDesc = "" +
	"\n" +
	"\x18api/v2/api_service.proto\x12\x06api.v2\x1a api/v2/forgot_password_rpc.proto\x1a\x1eapi/v2/get_user_data_rpc.proto\x1a\x16api/v2/login_rpc.proto\x1a\x19api/v2/register_rpc.proto\x1a\x1fapi/v2/reset_password_rpc.proto\x1a,api/v2/set_discord_connection_data_rpc.proto\x1a+api/v2/set_stripe_connection_data_rpc.proto\x1a!api/v2/update_user_data_rpc.proto2\xa4\x05\n" +
	"\n" +
	"ApiService\x12?\n" +
	...
	"\x17SetStripeConnectionData\x12&.api.v2.SetStripeConnectionDataRequest\x1a'.api.v2.SetStripeConnectionDataResponse\"\x00B\x87\x01\n" +
	"\n" +
