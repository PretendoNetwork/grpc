...
export const PNIDPermissionFlags: MessageFns<PNIDPermissionFlags> = {
  encode(message: PNIDPermissionFlags, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PNIDPermissionFlags {
